...
public class DataControllerImpl implements DataController {
  ...
  public String setStringValue(String key, String value) {
    ...
    try {
      ...
      final SetStringUseCase useCase =
          new SetStringImpl(dataAccess, view, DataConfig.MAX_LENGTH_STRING_VALUE);
  ...
  public String rightPushStringList(String key, String value) {
    ...
    try {
      ...
      final RightPushListUseCase useCase =
          new RightPushListImpl(dataAccess, view, DataConfig.MAX_LENGTH_STRING_VALUE);
